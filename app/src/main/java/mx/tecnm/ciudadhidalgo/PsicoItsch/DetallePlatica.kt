...
class DetallePlatica : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detalle_platica)
        ...
        inscribir.setOnClickListener {
            ...
            docRef.get().addOnSuccessListener {document->
                ...
                if(asistentes.count() == platica.cupo){
                    ...
                    docRef.update("asistentes", FieldValue.arrayUnion(usuario.email))
                        .addOnCompleteListener {
                            Toast.makeText(this,"Se registro correctamnte a la platica",Toast.LENGTH_SHORT).show()
